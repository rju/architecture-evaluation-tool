...
public class HypergraphDiagramSynthesis extends AbstractDiagramSynthesis<Hypergraph> {
  ...
  public KNode transform(final Hypergraph hypergraph) {
    ...
    final Procedure1<KNode> _function = (KNode it) -> {
      this.<KNode, Boolean>setLayoutOption(it, Properties.MERGE_EDGES, Boolean.valueOf(false));
      this.<KNode, Boolean>setLayoutOption(it, LayoutOptions.LAYOUT_HIERARCHY, Boolean.valueOf(false));
      this.<KNode, String>setLayoutOption(it, LayoutOptions.ALGORITHM, "de.cau.cs.kieler.kiml.ogdf.circular");
