...
public class TransformationAdapterFactory extends AdapterFactoryImpl {
	...
	protected TransformationSwitch<Adapter> modelSwitch =
		new TransformationSwitch<Adapter>() {
			...
			@Override
			public Adapter casePlanarVisualizationGraph(PlanarVisualizationGraph object) {
				return createPlanarVisualizationGraphAdapter();
			}
			@Override
			public Adapter casePlanarNode(PlanarNode object) {
				return createPlanarNodeAdapter();
			}
			@Override
			public Adapter casePlanarEdge(PlanarEdge object) {
				return createPlanarEdgeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.cau.cs.se.software.evaluation.graph.transformation.NamedElement <em>Named Element</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.cau.cs.se.software.evaluation.graph.transformation.PlanarVisualizationGraph <em>Planar Visualization Graph</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.cau.cs.se.software.evaluation.graph.transformation.PlanarNode <em>Planar Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.cau.cs.se.software.evaluation.graph.transformation.PlanarEdge <em>Planar Edge</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
