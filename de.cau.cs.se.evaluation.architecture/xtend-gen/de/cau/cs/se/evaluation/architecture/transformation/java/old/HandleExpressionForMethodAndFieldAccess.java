...
import de.cau.cs.se.evaluation.architecture.transformation.java.old.HandleStatementForMethodAndFieldAccess;
...
public class HandleExpressionForMethodAndFieldAccess {
  ...
  private void _findMethodAndFieldCallInExpression(final ClassInstanceCreation expression) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method createEdgeForField is undefined for the type HandleExpressionForMethodAndFieldAccess"
      + "\nThe method findConstructorMethod is undefined for the type HandleExpressionForMethodAndFieldAccess"
      + "\nThe method findNodeForMethod is undefined for the type HandleExpressionForMethodAndFieldAccess"
      + "\n!= cannot be resolved");
  }
  ...
  public boolean checkVariable(final VariableDeclarationFragment variable, final Edge edge) {
    ...
    if ((_derivedFrom instanceof FieldTrace)) {
      ...
      String _determineFullyQualifiedName = NameResolutionHelper.determineFullyQualifiedName(this.type, variable);
      return _name.equals(_determineFullyQualifiedName);
    }
    return false;
  }
  ...
  public boolean staticInvocation(final SimpleName name, final Node caller, final String calleeName, final List<Expression> calleeArguments) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method determineFullyQualifiedName(AbstractTypeDeclaration) is not visible");
  }
  
  private Object valueInvocation(final SimpleName variable, final Node caller, final String calleeName, final List<Expression> calleeArguments) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method findEdgeForVariable is undefined for the type HandleExpressionForMethodAndFieldAccess"
      + "\n== cannot be resolved");
  }
   ...
   */
  private Object methodInvocationViaInheritedField(final String variableName, final Node caller, final String calleeName, final List<Expression> calleeArguments) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method findNodeForMethod is undefined for the type HandleExpressionForMethodAndFieldAccess"
      + "\nThe method createNodeForMethodName is undefined for the type HandleExpressionForMethodAndFieldAccess"
      + "\nThe method determineFullyQualifiedName(AbstractTypeDeclaration) is not visible"
      + "\nThe method determineFullyQualifiedName(AbstractTypeDeclaration) is not visible"
      + "\nThe method determineFullyQualifiedName(AbstractTypeDeclaration) is not visible"
      + "\n== cannot be resolved"
