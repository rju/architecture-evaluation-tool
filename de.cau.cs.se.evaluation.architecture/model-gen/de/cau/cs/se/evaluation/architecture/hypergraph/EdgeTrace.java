 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.evaluation.architecture.hypergraph.EdgeTrace#getEdge <em>Edge</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.se.evaluation.architecture.hypergraph.HypergraphPackage#getEdgeTrace()
 * @model
 * @generated
 */
public interface EdgeTrace extends EdgeReference {
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.se.evaluation.architecture.hypergraph.EdgeTrace#getEdge <em>Edge</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
