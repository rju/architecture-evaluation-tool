 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.evaluation.architecture.hypergraph.Edge#getDerivedFrom <em>Derived From</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.se.evaluation.architecture.hypergraph.HypergraphPackage#getEdge()
 * @model
 * @generated
 */
public interface Edge extends NamedElement {
	 ...
	 * @see de.cau.cs.se.evaluation.architecture.hypergraph.HypergraphPackage#getEdge_DerivedFrom()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.se.evaluation.architecture.hypergraph.Edge#getDerivedFrom <em>Derived From</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
