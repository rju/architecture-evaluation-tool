 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.evaluation.architecture.state.SystemSetup#getRowPatternTable <em>Row Pattern Table</em>}</li>
 *   <li>{@link de.cau.cs.se.evaluation.architecture.state.SystemSetup#getSystem <em>System</em>}</li>
 *   <li>{@link de.cau.cs.se.evaluation.architecture.state.SystemSetup#getSystemGraph <em>System Graph</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.se.evaluation.architecture.state.StatePackage#getSystemSetup()
 * @model
 * @generated
 */
public interface SystemSetup extends EObject {
	 ...
	 * @see de.cau.cs.se.evaluation.architecture.state.StatePackage#getSystemSetup_RowPatternTable()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.se.evaluation.architecture.state.SystemSetup#getRowPatternTable <em>Row Pattern Table</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.se.evaluation.architecture.state.StatePackage#getSystemSetup_System()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.se.evaluation.architecture.state.SystemSetup#getSystem <em>System</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.se.evaluation.architecture.state.StatePackage#getSystemSetup_SystemGraph()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.se.evaluation.architecture.state.SystemSetup#getSystemGraph <em>System Graph</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
