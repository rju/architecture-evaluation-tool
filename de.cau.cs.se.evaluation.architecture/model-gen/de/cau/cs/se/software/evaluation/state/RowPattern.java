 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.software.evaluation.state.RowPattern#getNodes <em>Nodes</em>}</li>
 *   <li>{@link de.cau.cs.se.software.evaluation.state.RowPattern#getPattern <em>Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.se.software.evaluation.state.StatePackage#getRowPattern()
 * @model
 * @generated
 */
public interface RowPattern extends EObject {
	 ...
	 * @see de.cau.cs.se.software.evaluation.state.StatePackage#getRowPattern_Nodes()
	 * @model required="true"
	 * @generated
	 */
	EList<Node> getNodes();
	 ...
	 * @see de.cau.cs.se.software.evaluation.state.StatePackage#getRowPattern_Pattern()
	 * @model unique="false"
	 * @generated
	 */
