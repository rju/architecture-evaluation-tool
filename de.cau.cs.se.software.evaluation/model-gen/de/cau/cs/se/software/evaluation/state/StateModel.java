 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.software.evaluation.state.StateModel#getSubsystems <em>Subsystems</em>}</li>
 *   <li>{@link de.cau.cs.se.software.evaluation.state.StateModel#getMainsystem <em>Mainsystem</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.se.software.evaluation.state.StatePackage#getStateModel()
 * @model
 * @generated
 */
public interface StateModel extends EObject {
	 ...
	 * The list contents are of type {@link de.cau.cs.se.software.evaluation.state.SystemSetup}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.cau.cs.se.software.evaluation.state.StatePackage#getStateModel_Subsystems()
	 ...
	 * @see de.cau.cs.se.software.evaluation.state.StatePackage#getStateModel_Mainsystem()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.se.software.evaluation.state.StateModel#getMainsystem <em>Mainsystem</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
